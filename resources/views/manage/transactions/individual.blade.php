            ...
            <div class="col-lg-6">                
                ...
                <div class="user-data m-b-30">
                    ...
                    <div class="filters m-b-30">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <select name="customer_id" style="width:100%;" class="customer form-control " id="">
                                    </select>
                                    <input type="hidden" name="service_category_value" value="">
                                </div>
                                <div class="col-6">
                                    <select name="service_category_id" style="width:100%;" class="form-control " id="service_category_id">
                    ...
                    <div class="filters m-b-45">
                        <div class="row">
                            ...
                            <div class="col-4">
                                    <input type="number"  name="price" id="price" class="form-control  mb-2 mr-2 mr-sm-2" value="0" readonly>
        ...
        if ((customer_id != null) || (collections.length < 1) || (amt == 0)) {
            $.ajax({
                ...
                data: {
                    ...
                    total: total,
                    short_note: 'Individual Transaction',
